...
# LLM_VERSION="/group/40005/auroraji/LLaDA-V/train/exp/llada_v_finetune_base/checkpoint-2000"
...
BASE_RUN_NAME="llada_v_finetune_23"
# OUTPUT_DIR="/home/jyt-tmp/LLada-V/$BASE_RUN_NAME"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node=${gpu_num} --nnodes=${num_node} --master_addr=${MASTER_ADDR} --master_port ${MASTER_PORT} --node_rank=${RANK} \
    ...
    --data_path "/group/40005/public_datasets/ViCrit-Train/vicrit_train_equaltokens.json" \
    --image_folder "/group/40005/public_datasets/ViCrit-Train/images" \
    --image_folder_2 "/group/40005/public_datasets" \
    --video_folder "" \
